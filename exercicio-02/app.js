...
const programmingLinguage = 'JavaScript'
const js = programmingLinguage[0] + programmingLinguage[4]
...
// console.log(programmingLinguage.length)
...
newName = `${name[0].toLocaleUpperCase()}${name.slice(
  1,
  6
)} ${name[7].toLocaleUpperCase()}${name.slice(8)}`
